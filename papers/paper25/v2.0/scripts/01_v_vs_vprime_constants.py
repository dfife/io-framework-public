#!/usr/bin/env python3
"""Recompute the Paper 25 v2.0 V-versus-V' constants.
...
R4/FIRAS boundary:
    ...
    This script does not use the observer-side thermal readout normalization
    R4. It uses only the Barbero-Immirzi input, the Paper 21 puncture loads,
    and the Paper 25 branch formulas. CMB-temperature prediction claims are
    outside this script and are retired by the Paper 17 v1.5 R4/FIRAS repair.
...
or from the repository root:
    ...
    python3 papers/paper25/v2.0/scripts/01_v_vs_vprime_constants.py
"""
...
def main() -> None:
    ...
    result = {
        ...
        "claim_boundary": "K_gauge is the finite modular payload; Paper 25 tests whether the weak rate reads K_gauge or V'. R4_FIRAS is not used in this computation."
    }
