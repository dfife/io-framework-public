#!/usr/bin/env python3
"""Emit the Paper 25 live theorem and premise ledger.
...
Theorems 25.1-25.12, the channel-budget equation, and the 29 killed-route
count. This script does not prove those theorems; it makes the status labels
and conditional dependencies machine-readable for review.
"""
...
def main() -> None:
    ...
    theorem_ledger = [
        ...
        {"id": "25.2", "name": "Scalarization Preserves V-Type", "status": "CONDITIONAL/THEOREM"},
        ...
        {"id": "25.11", "name": "Structural Exclusion of V''", "status": "CONDITIONAL/THEOREM on H1 via 25.12"},
        {"id": "25.12", "name": "R(gamma)=1 on constructed extension", "status": "DERIVED on constructed extension; CONDITIONAL on H1"}
    ]
    ...
    result = {
        ...
        "channel_budget_equation": {
            ...
            "status": "CONDITIONAL on channel-to-payload assignment; WMR resolved by Paper 25 inside H1-H3"
        },
        "closed_open_problem": {
            "id": "WMR",
            "statement": "weak rate reads V = K_gauge, not V'",
            "status": "closed inside H1-H3"
        },
