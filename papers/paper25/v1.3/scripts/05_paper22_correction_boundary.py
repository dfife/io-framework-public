#!/usr/bin/env python3
"""Document the Paper 22 weak-amplitude correction induced by Paper 25.
...
comparison used by the Paper 25 v1.2/v1.3 manuscript.
"""
...
def main() -> None:
    ...
    result = {
        ...
        "paper25_active_branch": {
            ...
            "epsilon_w": new,
            "status": "DERIVED/CONDITIONAL on H1-H3 plus upstream L_1"
        },
        "correction": {
