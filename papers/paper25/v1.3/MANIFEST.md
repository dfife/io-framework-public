...
- `data/imported_constants.json`: framework constants, amplitudes,
  observational denominators, active BBN scorecards, and H1-H3 premise text.
...
- `scripts/06_kappa_audit_summary.py`: emits the compact audit verdict.
