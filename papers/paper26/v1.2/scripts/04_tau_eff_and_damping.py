#!/usr/bin/env python3
"""Recompute Paper 26's effective optical damping parameter.

If C3 selects the inverse tangential propagator readout, the source amplitude is
damped by exp(-K_gauge). Standard TT notation writes the observed combination
as A_eff = A_s exp(-2 tau), so this corresponds to tau_eff = K_gauge / 2.
...
def main() -> None:
    ...
    result = {
        ...
        "status": "DERIVED/CONDITIONAL on C3",
