#!/usr/bin/env python3
"""Reproduce the Paper 26 CMB baryon-class diagnostic ledger.
...
script does not rerun CLASS. It emits the frozen audited CLASS diagnostic rows
and their deltas so reviewers can check the manuscript's numerical support
surface.
"""
