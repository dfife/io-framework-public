# Paper 32 v1.6 Reproducibility Bundle
...
Paper 32 v1.6 repairs the Paper 17 optical-readout dependency inherited by
...
- the v1.6 R4/FIRAS impact audit identifying CMB-prediction language that must
...
The `reports/` directory includes the framework-closure kappa audit, the v1.6
