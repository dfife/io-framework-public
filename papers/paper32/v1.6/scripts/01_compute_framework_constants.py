#!/usr/bin/env python3
"""
Paper 32 v1.6 reproducibility script 01.

Purpose:
    Recompute the framework constants table used by Paper 32 v1.6 from the
    ...
    The v1.6 repair is explicit: the observed CMB temperature is not treated
...
def main() -> int:
    ...
    # Active v1.6 readout: FIRAS fixes R4 once; downstream scripts may not
