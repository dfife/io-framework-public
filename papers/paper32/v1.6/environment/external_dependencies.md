...
The Paper 32 v1.6 public scripts require only Python standard-library modules.
...
- `T_IO = 2.6635 K`, the IO interior thermal scale.
- `T_FIRAS = 2.7255 K`, the FIRAS empirical observer-side thermal datum used
  to fix `R4_FIRAS` in the Paper 17 v1.5 readout family.
