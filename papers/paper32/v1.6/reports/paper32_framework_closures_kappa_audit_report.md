...
`P4/R4` wording is superseded by the v1.6 R4/FIRAS audit in:

```text
reports/paper32_v16_r4_firas_kappa_audit_report.md
```

For Paper 32 v1.6, read every `P4/R4` closure phrase in this historical report
...
|---|---|
| P4 source-block normalization | `DERIVED/SCOPED` on active source block; not universal. Optical R4 is FIRAS-fixed by Paper 17 v1.5, not derived by KB7. |
