...
- Paper 32 paragraph 152:
  `Theorem 32.KB.7 (DtN Open-Transport Placement Theorem, DERIVED/CONDITIONAL_VERIFIED)`
...
- Paragraph 182:
  `Therefore P4 is DERIVED/CONDITIONAL_VERIFIED on the active reduced scalar source block.`
