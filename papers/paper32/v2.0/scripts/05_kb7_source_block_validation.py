#!/usr/bin/env python3
"""
Paper 32 v2.0 reproducibility script 05.

Purpose:
    Reproduce the public structural validation surface for Theorem 32.KB.7:
    the DtN Open-Transport Placement closes the P4 fixed-point normalization
    only on the active reduced scalar source block.

    This is deliberately not a Paper 17 optical-R4 proof. Paper 32 v2.0
    separates the KB7/P4 source-block result from the FIRAS-fixed R4 thermal
...
Claim boundary:
    ...
    validates the scalar identities used by the manuscript. It does not derive
    the Paper 17 optical readout coefficient R4.
"""
    ...
    gates = [
        {
            ...
            "meaning": "The physical P4-carrying observable is the active source/readout block, not optical R4, thermal, recombination, or history blocks."
        },
        {
