#!/usr/bin/env python3
"""Paper 35 v1.2 script 06: JWST formation-time table.

Purpose:
    Reproduce the high-redshift age comparison table for the IO bare master
    clock and the Planck/LambdaCDM comparator.  The radiation-density input now
    uses the FIRAS empirical temperature; no independent CMB-temperature
