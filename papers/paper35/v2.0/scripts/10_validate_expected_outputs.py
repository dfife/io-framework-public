...
CHECKS: list[dict[str, Any]] = [
    ...
    {
        "id": "desi_imported_lya_alpha_parallel",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "alpha_parallel"),
        "expected": 0.9905,
        "tolerance": 1e-15,
        "claim_type": "imported exterior Ly-alpha redshift-space flux-shift class under P2",
    },
    {
        "id": "desi_imported_lya_alpha_perp",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "alpha_perp"),
        "expected": 0.9905,
        "tolerance": 1e-15,
        "claim_type": "imported exterior Ly-alpha redshift-space flux-shift class under P2",
    },
    {
        "id": "desi_imported_lya_alpha_sigma",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "alpha_iso_sigma"),
        "expected": 0.0027,
        "tolerance": 1e-15,
        "claim_type": "imported exterior Ly-alpha redshift-space flux-shift uncertainty under P2",
    },
    {
        "id": "desi_imported_lya_shift_chi2",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "chi2_central_shift_only"),
        "expected": 26.296401887105667,
        "tolerance": 1e-9,
        "claim_type": "fixed DESI covariance chi2 with Paper 29 scoped BAO kernel plus imported Ly-alpha shift",
    },
    {
        "id": "desi_imported_lya_shift_pte",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "diagnostics_central_shift_only", "pte_chi2_survival"),
        "expected": 0.015508017004462981,
        "tolerance": 1e-15,
        "claim_type": "fixed DESI covariance chi2 survival with imported Ly-alpha shift",
    },
    {
        "id": "desi_imported_lya_shift_covariance_chi2",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "chi2_with_shift_uncertainty_covariance"),
        "expected": 26.290695872127714,
        "tolerance": 1e-9,
        "claim_type": "DESI covariance chi2 with imported Ly-alpha shift uncertainty propagated",
    },
    {
        "id": "desi_imported_lya_shift_covariance_pte",
        "file": "desi_confrontation_results.json",
        "path": (
            "conditional_imported_lya_shift_bao_readout",
            "diagnostics_with_shift_uncertainty_covariance",
            "pte_chi2_survival",
        ),
        "expected": 0.01553556040587586,
        "tolerance": 1e-15,
        "claim_type": "DESI covariance chi2 survival with imported Ly-alpha shift uncertainty propagated",
    },
    {
        "id": "desi_imported_lya_shift_delta_chi2",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "delta_chi2_central_shift_minus_lcdm"),
        "expected": -3.573348643586605,
        "tolerance": 1e-9,
        "claim_type": "imported Ly-alpha branch minus LambdaCDM same-data chi2 difference",
    },
    {
        "id": "desi_imported_lya_shift_covariance_delta_chi2",
        "file": "desi_confrontation_results.json",
        "path": ("conditional_imported_lya_shift_bao_readout", "delta_chi2_with_shift_uncertainty_minus_lcdm"),
        "expected": -3.579054658564558,
        "tolerance": 1e-9,
        "claim_type": "imported Ly-alpha branch with propagated shift uncertainty minus LambdaCDM same-data chi2 difference",
    },
    {
