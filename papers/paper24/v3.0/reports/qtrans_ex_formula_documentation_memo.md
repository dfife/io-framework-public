# Paper 24 v3.0 Q_trans,ex Formula Documentation Memo

Classification: `VERIFIED / documentation_audit / PAPER24_V30_QTRANS_EX_FORMULA`
...
This matches the local v3.0 recomputation output for the Henderson corrected
...
- `DERIVED/CONDITIONAL_VERIFIED`: the physical import rule mapping measured
  `B(E2)` to the Paper 24 branch-projected transition quadrupole scale under
  the stated bridge and imported nuclear-input package.
