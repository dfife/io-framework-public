# Paper 24 v3.0 Excited-State Import Recalculation

Classification: `VERIFIED / recomputation / PAPER24_V30_EXCITED_STATE_IMPORT`
...
- `DERIVED/CONDITIONAL_VERIFIED`: the import rule mapping measured `B(E2)` to the Paper 24 TT branch-dressing scale under the stated bridge and nuclear-input package.
- `RECONSTRUCTION/RESEARCH_ONLY`: Fasano 2021 and McCoy 2020 theoretical derivations are not load-bearing imports.
- `RECONSTRUCTION/RESEARCH_ONLY`: Odell/BRICK ANCs are not authoritative for this recomputation until author-verified data are received.
