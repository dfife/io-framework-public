# Paper 24 v2.2 Excited-State Import Recalculation
...
This means v2.2 should not say the central value is literally unchanged. It can say the primary-source excited-state response preserves the Paper 24 lithium result within the imported-source/convention band.
