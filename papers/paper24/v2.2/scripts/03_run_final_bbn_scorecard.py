#!/usr/bin/env python3
"""
Paper 24 v2.2 reproducibility script 03.

Purpose:
    Recompute the excited-branch kernel calculation and the PRyMordial BBN
    scorecard used by Paper 24 v2.2. This script is the only PRyMordial-
...
if not PRYM_ROOT_ENV:
    raise SystemExit(
        "PRYM_ROOT is required for the full Paper 24 v2.2 PRyMordial rerun. "
...
def main() -> None:
    ...
    # weighted value is the branch object used by the v2.2 support chain.
