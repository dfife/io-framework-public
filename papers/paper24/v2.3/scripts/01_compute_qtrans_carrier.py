#!/usr/bin/env python3
"""
Paper 24 v2.3 reproducibility script 01.
...
def compute() -> dict:
    """Return the Paper 24 v2.3 Q_trans carrier audit payload."""

    # IO and BBN constants used by the Paper 24 v2.3 carrier calculation.
    x = 1.519
    gamma = 0.2375
    q_d_barn = 0.0028578
    ...
    # Paper 24 v2.3 reports the carrier scale before the x^{-1} projection.
