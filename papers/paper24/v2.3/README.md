...
reports needed to audit the Paper 24 v2.3 lithium result.

The computational contents are numerically unchanged from the Paper 24 v2.2
support bundle. This v2.3 folder exists so the reproducibility URL matches the
manuscript version after the paper-side citation update.
