#!/usr/bin/env python3
"""
Paper 34 v2.0 reproducibility script 01.
...
Claim boundary:
    ...
    The x^((n/2)*K_gauge) factor is the H0 stellar-photometric half-leg
    payload. It is not the Paper 17 optical thermal R4 readout
...
def main() -> int:
    ...
    consistency = {
        ...
        "x_half_leg_matches_x_pow_K_over_2": math.isclose(
            constants["x_half_leg"], x_value ** (k_gauge / 2.0), rel_tol=0.0, abs_tol=1e-15
        ),
    }
    ...
    results = {
        ...
        "claim_boundary": payload["R4_repair_boundary"],
        "constants": constants,
