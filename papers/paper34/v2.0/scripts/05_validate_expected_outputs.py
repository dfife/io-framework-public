#!/usr/bin/env python3
"""
Paper 34 v2.0 reproducibility script 05.

Purpose:
    Fast validation of the frozen JSON outputs shipped in the Paper 34 v2.0
    support bundle.
...
CHECKS = [
    ...
    ("r4_firas_impact_audit_results.json", ("R4_FIRAS", "value"), 1.0031014644105183, 1e-15),
    ("r4_firas_impact_audit_results.json", ("verdict", "paper34_H_ext_formula_uses_R4"), False, 0),
    ("r4_firas_impact_audit_results.json", ("verdict", "paper34_scorecard_changed_by_R4_FIRAS"), False, 0),
    ("r4_firas_impact_audit_results.json", ("verdict", "cmb_temperature_prediction_present"), False, 0),
    (
        "r4_firas_impact_audit_results.json",
        ("unchanged_headline_predictions", "SH0ES_TRGBSN_alpha_2_n_2"),
        73.04406074030152,
        1e-12,
    ),
]
