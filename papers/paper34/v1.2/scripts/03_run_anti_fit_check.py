#!/usr/bin/env python3
"""
Paper 34 v1.2 reproducibility script 03.
...
Claim boundary:
    ...
    measurements.
    R4 is included only as a rejected counterfactual payload diagnostic. It is
    not part of the Paper 34 H_ext formula.
"""
...
def payload_rivals(constants: dict) -> dict:
    ...
    rivals = {
        "K_gauge": k_gauge,
        "R4_times_K_gauge_rejected_counterfactual": constants["R4_FIRAS"] * k_gauge,
...
def main() -> int:
    ...
    results = {
        ...
        "claim_boundary": "anti-fit diagnostic, not an independent proof of the extension premises; R4_times_K_gauge is a rejected counterfactual, not the active Paper 34 payload",
        "method_rows": rows,
