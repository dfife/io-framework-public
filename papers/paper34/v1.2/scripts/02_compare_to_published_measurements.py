#!/usr/bin/env python3
"""
Paper 34 v1.2 reproducibility script 02.
...
Claim boundary:
    ...
    The Planck CMB row is a CMB-inferred H0 method class, not an independent
    prediction of the observed CMB temperature.
"""
...
def main() -> int:
    ...
    results = {
        ...
        "claim_boundary": constants["R4_repair_boundary"],
        "scorecard": scorecard,
        "summary": {
