# Paper 34 v1.2 Script Guide

Classification: `verified / public-reproducibility-support / R4-FIRAS audited`

This folder contains the executable support scripts for the Paper 34 v1.2
...
`Planck CMB` scorecard row is a Planck CMB-inferred H0 method-class row.
