...
v1.2 note: this report is retained as the original H_ext(alpha,n) structural
audit. The separate v1.2 R4/FIRAS impact audit in
`paper34_v12_r4_firas_kappa_audit_report.md` verifies that the Paper 17 v1.5
