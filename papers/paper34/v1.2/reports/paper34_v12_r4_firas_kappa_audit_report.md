# Paper 34 v1.2 R4/FIRAS repair and kappa-style impact audit

Status: verified / structural-audit / v1.2 bundle support
...
The only v1.1 damage found was wording hygiene: the Planck row used the phrase `geometric CMB readout`, which could be misread as a CMB-temperature prediction. In v1.2 this was replaced with:
...
The v1.2 scorecard is unchanged from v1.1:
...
The v1.2 audit script intentionally computes the rejected diagnostic:
...
Paper 34 v1.2 does not require a numerical Hubble-scorecard update from the R4/FIRAS repair.
