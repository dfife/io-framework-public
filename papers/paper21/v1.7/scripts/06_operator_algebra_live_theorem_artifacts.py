#!/usr/bin/env python3
"""Paper 21 v1.7 reproducibility script 06.
...
Purpose:
    ...
    nontraciality, and Wigner-Eckart selection failure.
...
def main() -> int:
    ...
    payload = {
        ...
        "branch_assignment": {
            ...
            "T_IO_K": fw["T_IO_K"],
            "T_obs_K": fw["T_obs_K"],
            "GTTP_formula": "T_obs = T_IO x^K_gauge",
            "T_obs_recomputed": fw["T_IO_K"] * (fw["x"] ** fw["K_gauge"]),
