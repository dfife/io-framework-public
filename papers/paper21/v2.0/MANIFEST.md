# Paper 21 v2.0 Bundle Manifest

Classification: `VERIFIED / public-reproducibility-support`

This manifest inventories the Paper 21 v2.0 reproducibility bundle. SHA256
...
- `environment/external_dependencies.md`: PRyMordial, Paper 17 v1.5 R4/FIRAS,
  and conventions notes.

## Data

- `data/imported_constants.json`: framework constants, `R4_FIRAS`,
  puncture-load expected values, observational denominators, and frozen
  corrected Big Bang nucleosynthesis support values.
...
- `scripts/02_derive_L1_puncture_load.py`
- `scripts/03_derive_L2_puncture_load.py`
- `scripts/04_compute_ac1_closure.py`
- `scripts/05_prymordial_wrapper_conventions.py`
- `scripts/06_generate_bbn_scorecard.py`
- `scripts/07_operator_algebra_live_theorem_artifacts.py`
...
- `reports/paper21_v20_r4_kappa_audit_report.md`
- `reports/paper21_v20_r4_kappa_audit_results.json`
- `reports/paper21_reproducibility_script_manifest.md`

## Excluded

The private Paper 21 folder contains additional historical route rerunners.
They are excluded from this public bundle by PI instruction and by the v2.0
scope reduction. The bundle does not rerun retired or superseded routes.
...
convention, denominators, R4 dependency inheritance, and theorem-support
arithmetic.
