...
def main() -> None:
    result = {
        ...
        "audit": "Paper 22 v2.0 paper-level kappa-style structural audit",
        ...
        "visible_conditional_fields": [
            {
                "field": "GMP",
                "classification": "OPEN/PREMISE_GAP",
            ...
            {
                "field": "WMR(H1-H3)",
                "classification": "DERIVED/CONDITIONAL_VERIFIED on H1-H3",
                "promotion_path": "physical selection of the Paper 25 two-time KMS/CCR bridge observable"
            },
            {
                "field": "rate-dressing orientation sign",
                "classification": "VERIFIED convention, not a continuous fitted parameter",
                "promotion_path": "explicit positivity/suppression orientation theorem"
            },
            {
                "field": "R4 optical readout normalization",
                "classification": "IMPORTED/EMPIRICAL plus VERIFIED uniqueness in Paper 17; not active in Paper 22 scorecard",
                "promotion_path": "none in Paper 22; CMB-temperature prediction language is retired"
            }
        ],
        "derived_core": [
        ...
        "conditional_core": [
            "zero-parameter amplitude construction inside the stated premise package",
        ...
        "claim_boundary": [
            ...
            "Do not say Paper 22 independently predicts the CMB temperature."
        ],
        "reports": [
